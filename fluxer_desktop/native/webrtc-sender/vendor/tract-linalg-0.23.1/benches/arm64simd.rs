...
pub unsafe fn armv8(filter: Option<&str>) {
    ...
    s128!("fmax_with_dep", 1, {
        asm!("fmax v0.4s, v0.4s, v0.4s", out("v0") _)
    });
    s128!("fmla", 16, {
    ...
    s128!("fmla_with_dep", 1, {
        asm!("fmla v0.4s, v0.4s, v0.4s", out("v0") _)
    });
    s32!("w_load", 64, {
        let mut p = F32;
        r8!(asm!("ldr w20, [{0}]
...
pub unsafe fn asimdhp(filter: Option<&str>) {
    ...
    s32!("fmlahp_with_dep", 1, {
        asm!("fmla v0.8h, v0.8h, v0.8h", out("v0") _)
    });
    s32!("fcvtn_with_dep", 1, {
        asm!("fcvtn v0.4h, v0.4s", out("v0") _)
    });
    s32!("fcvtn2_with_dep", 1, {
        asm!("fcvtn2 v0.8h, v0.4s", out("v0") _)
    });
}
...
unsafe fn f32_8x8(f: Option<&str>) {
    ksimd!(
        ...
        "8x8x1xf32",
        64,
        "arm64simd_mmm_f32_8x8/packed_packed_loop1/naive.tmpli"
    );
    ksimd!(
        f,
        4,
        "8x8x1xf32",
        64,
        "arm64simd_mmm_f32_8x8/packed_packed_loop1/broken_chains.tmpli"
    );
    ksimd!(
        f,
        4,
    ...
    ksimd!(
        ...
        "8x8x1xf32",
        64,
        "arm64simd_mmm_f32_8x8/packed_packed_loop1/ldr_x_preload.tmpli"
    );
    ksimd!(
        f,
        4,
    ...
    ksimd!(
        ...
        "8x8x1xf32",
        64,
        "arm64simd_mmm_f32_8x8/packed_packed_loop1/ldr_w_preload.tmpli"
    );
    ksimd!(
        f,
        4,
        "8x8x2xf32",
        128,
        "arm64simd_mmm_f32_8x8/packed_packed_loop2/broken_chains.tmpli"
    );
    ksimd!(
        f,
        4,
        "8x8x2xf32",
        128,
        "arm64simd_mmm_f32_8x8/packed_packed_loop2/cortex_a55.tmpli"
    );
}
...
unsafe fn f32_12x8(f: Option<&str>) {
    ksimd!(
        ...
        "12x8x1xf32",
        96,
        "arm64simd_mmm_f32_12x8/packed_packed_loop1/naive.tmpli"
    );
    ksimd!(
        f,
        4,
    ...
    ksimd!(
        ...
        "12x8x2xf32",
        192,
        "arm64simd_mmm_f32_12x8/packed_packed_loop2/cortex_a55.tmpli"
    );
}
...
unsafe fn f32_16x4(f: Option<&str>) {
    ksimd!(
        ...
        "16x4x1xf32",
        64,
        "arm64simd_mmm_f32_16x4/packed_packed_loop1/naive.tmpli"
    );
    ksimd!(
        f,
        4,
        "16x4x1xf32",
        64,
        "arm64simd_mmm_f32_16x4/packed_packed_loop1/cortex_a53.tmpli"
    );
    ksimd!(
        f,
        4,
        "16x4x2xf32",
        128,
        "arm64simd_mmm_f32_16x4/packed_packed_loop2/cortex_a55.tmpli"
    );
}
...
unsafe fn f32_24x4(f: Option<&str>) {
    ksimd!(
        ...
        "24x4x1xf32",
        96,
        "arm64simd_mmm_f32_24x4/packed_packed_loop1/naive.tmpli"
    );
    ksimd!(
        f,
        4,
        "24x4x1xf32",
        96,
        "arm64simd_mmm_f32_24x4/packed_packed_loop1/cortex_a53.tmpli"
    );
    ksimd!(
        f,
        4,
        "24x4x1xf32",
        96,
        "arm64simd_mmm_f32_24x4/packed_packed_loop1/cortex_a55.tmpli"
    );
}
...
unsafe fn f32_64x1(f: Option<&str>) {
    ksimd!(
        ...
        "64x1x1xf32",
        64,
        "arm64simd_mmm_f32_64x1/loop1/naive.tmpli"
    );
    ksimd!(
        f,
        4,
        "64x1x1xf32",
        64,
        "arm64simd_mmm_f32_64x1/loop1/cortex_a53.tmpli"
    );
    ksimd!(
        f,
        4,
        "64x1x2xf32",
        128,
        "arm64simd_mmm_f32_64x1/loop2/naive.tmpli"
    );
    ksimd!(
        f,
        4,
        "64x1x2xf32",
        128,
        "arm64simd_mmm_f32_64x1/loop2/cortex_a55.tmpli"
    );
}
...
unsafe fn f16_16x8(f: Option<&str>) {
    kfp16!(
        ...
        "16x8x1xf16",
        128,
        "arm64fp16_mmm_f16_16x8/loop1/naive.tmpli"
    );
    kfp16!(
        f,
        8,
        "16x8x2xf16",
        256,
        "arm64fp16_mmm_f16_16x8/loop2/cortex_a55.tmpli"
    );
    kfp16!(
        f,
        8,
        "32x4x1xf16",
        128,
        "arm64fp16_mmm_f16_32x4/loop1/naive.tmpli"
    );
    kfp16!(
        f,
        8,
        "32x4x2xf16",
        256,
        "arm64fp16_mmm_f16_32x4/loop2/cortex_a55.tmpli"
    );
}
