...
export const CONTENT_I18N_FI_MESSAGES = defineContentI18nLocaleMessages({
	...
	"guild.bulk_create.emoji_limit": "Enimmäismäärä emoji-kuvakkeita on saavutettu ({limit}).",
	"guild.bulk_create.sticker_limit": "Saavutettu enimmäismäärä tarroja ({limit}).",
