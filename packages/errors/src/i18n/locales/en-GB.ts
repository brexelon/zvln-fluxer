...
export const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	"age_verification.invalid_card_type": "Only credit cards are accepted for age verification. Debit and prepaid cards can't be used.",
	...
	"channels_and_guilds.guild_id_must_match_referenced_message": "Community ID must match the channel the referenced message was fetched from.",
	"channels_and_guilds.guild_template_fetch_failed": "Failed to fetch the community template. The template may not exist or the external service is unavailable.",
	...
	"channels_and_guilds.max_guild_channels_reached": "You've reached the maximum of {count} community {count, plural, one {channel} other {channels}}.",
	"channels_and_guilds.max_guild_members_reached": "You've reached the maximum of {count} community {count, plural, one {member} other {members}}.",
	"channels_and_guilds.max_guild_roles_reached": "You've reached the maximum of {count} community {count, plural, one {role} other {roles}}.",
	"channels_and_guilds.max_guilds_reached": "You've reached the maximum of {count} {count, plural, one {community} other {communities}}.",
	...
	"channels_and_guilds.new_account_guild_join_rate_limited": "New accounts are limited to joining 10 communities in the first 24 hours. Please try again later.",
	...
	"content_and_safety.nsfw_emoji_sticker_blocked": "This emoji or sticker is classified as NSFW and cannot be used in this context.",
	...
	"media_and_memes.max_favorite_meme_tags_exceeded": "You can only add up to {limit} {limit, plural, one {tag} other {tags}} per favourite meme.",
	...
	"misc_limits.max_applications_reached": "You've reached the maximum of {limit} {limit, plural, one {application} other {applications}}.",
	...
	"names_and_normalization.channel_name_empty_after_normalization": "Channel name can't be empty after normalisation.",
	...
	"rate_limits.voice_activity_sharing_on_cooldown": "You can only update your voice activity sharing default once every 24 hours. Please try again in {retry_after} {retry_after, plural, one {second} other {seconds}}.",
	...
	"stripe.eu_withdrawal_waiver_required": "Please confirm the EU/EEA digital content withdrawal waiver before starting checkout.",
	...
	"webhooks.max_webhooks_per_guild_reached": "You've reached the maximum of {count} {count, plural, one {webhook} other {webhooks}} per community.",
